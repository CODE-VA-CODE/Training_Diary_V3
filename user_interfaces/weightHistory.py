...
# Form implementation generated from reading ui file 'user_interfaces\weightHistory.ui'
#
...
class Ui_MainWindow_History(object):
    def setupUi(self, MainWindow_History):
        ...
        MainWindow_History.resize(424, 376)
        self.centralwidget = QtWidgets.QWidget(MainWindow_History)
        self.centralwidget.setObjectName("centralwidget")
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(10, 0, 251, 331))
        ...
        self.btnClose.setGeometry(QtCore.QRect(270, 0, 141, 31))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow_History):
        ...
        item.setText(_translate("MainWindow_History", "Вес"))
